...
export default function MPRDetails() {
  ...
  const getMonthlyReport = (month: string, year: number): MonthlyTaskReport => {
    const monthCapitalized = month.charAt(0).toUpperCase() + month.slice(1);
    
    // Mock task data based on month/year
    const mockTasks: TaskDetail[] = [
      {
        ...
        priority: 'high',
        status: 'completed',
        startDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-01`,
        completedDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-15`,
        estimatedHours: 40,
        actualHours: 38,
      ...
      },
      {
        ...
        priority: 'medium',
        status: 'completed',
        startDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-05`,
        completedDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-20`,
        estimatedHours: 20,
        actualHours: 25,
        category: 'Database',
        assignedBy: 'Sarah Johnson'
      },
      {
        ...
        priority: 'high',
        status: 'completed',
        startDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-10`,
        completedDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-28`,
        estimatedHours: 35,
        actualHours: 32,
      ...
      },
      {
        ...
        priority: 'medium',
        status: 'in-progress',
        startDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-20`,
        estimatedHours: 15,
        actualHours: 8,
      ...
      },
      {
        ...
        priority: 'low',
        status: 'pending',
        startDate: `${year}-${month === 'december' ? '12' : month === 'november' ? '11' : '10'}-25`,
        estimatedHours: 25,
        category: 'Testing',
        assignedBy: 'Sarah Johnson'
      }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-2xl font-bold text-gray-900">
                {report.month} {report.year} - Task Report
              </h1>
